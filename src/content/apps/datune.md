...
coverImage: "../../assets/projects/DaTune_logo_1024px_bw.001.jpg"
span: 2
featured: true
category: "Apps"
...
DaTune removes distractions so you can focus on creating. A tuner, metronome,
...
<div class="reveal-on-scroll flex flex-col md:flex-row items-center gap-8">
    <div class="flex-1">
    ...
    <div class="flex-1 flex justify-center">
      <img src="/projects/datune/tuner.jpg" alt="Visual Particle Tuner" class="max-w-[200px] md:max-w-[250px] rounded-xl shadow-lg border border-zinc-800/50" />
    </div>
  </div>

<!-- Hybrid Metronome -->
<div class="reveal-on-scroll flex flex-col md:flex-row-reverse items-center gap-8">
    <div class="flex-1">
    ...
    <div class="flex-1 flex justify-center">
      <img src="/projects/datune/metronome.jpg" alt="Hybrid Metronome" class="max-w-[200px] md:max-w-[250px] rounded-xl shadow-lg border border-zinc-800/50" />
    </div>
  </div>
...
<div class="reveal-on-scroll flex flex-col md:flex-row items-center gap-8">
    ...
    <div class="flex-1 flex justify-center">
      <img src="/projects/datune/looper.jpg" alt="Creative Looper" class="max-w-[200px] md:max-w-[250px] rounded-xl shadow-lg border border-zinc-800/50" />
    </div>
  </div>
...
<div class="reveal-on-scroll flex flex-col md:flex-row-reverse items-center gap-8">
    ...
    <div class="flex-1 flex justify-center">
      <img src="/projects/datune/memos.jpg" alt="Smart Memos & Auto-Analysis" class="max-w-[200px] md:max-w-[250px] rounded-xl shadow-lg border border-zinc-800/50" />
    </div>
  </div>
...
Make it yours with a fully customizable three-color palette. The entire app
shifts to match your vibe.

## Unlock More (In-App Purchase)

- **Live Effects Per Layer:** Shape each loop with Pan, Pitch, Reverb, and
  Delay.
- **BLE MIDI Support:** Connect external bluetooth midi controllers for
  hands-free looping and performance.
- **Interactive Backgrounds:** Unlock a generative Conway’s Game of Life
  backdrop that evolves as you play.

---

[Privacy Policy](/legal/datune-privacy)
